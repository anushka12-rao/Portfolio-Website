export const mockProfile = {
  ...
  stats: [
    ...
    { label: "Production Users", value: "250K+" },
    { label: "Code Contributions", value: "1.2K+" }
  ]
};
...
export const mockProjects = [
  ...
  },
  {
    ...
    slug: "synthetix-ai-copilot",
    description: "Context-aware LLM assistant that ingests internal confluence docs and git repos to provide instant architectural guidance for engineering teams.",
    technologies: ["React", "Python", "FastAPI", "VectorDB", "Tailwind CSS"],
...
export const mockAchievements = [
  ...
  },
  {
    ...
    description: "Proficiency in Kubernetes deployment, core cluster architecture, networking, storage, and security configuration.",
    date: "2022-11",
